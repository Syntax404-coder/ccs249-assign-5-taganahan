...
def main():
    ...
    for document in documents:
        if document:
            # Clean the text (remove unwanted characters and convert to lowercase)
    ...
    # Calculate TF, IDF, and TF-IDF vectors
    ...
    # Calculate cosine similarity between two specific documents (in this case, documents at index 2 and 4)
